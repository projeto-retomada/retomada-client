        ...
        <CCardBody>
            <div v-if="!isEmpty">
                <p class="p-color-blue-35 u-margin-bottom-0">
                    <calendar-blank-multiple/> Atividades em andamento
                </p>
                <div v-if="!onGoing.length" class="u-margin-top-3 u-margin-bottom-3 u-padding-left-2">
                    <i-circle/> Não existem atividades em andamento
                </div>
            ...
            <div v-if="!isEmpty">
                <p class="p-color-purple-60 u-margin-bottom-0">
                    <calendar-blank-multiple/> Atividades agendadas
                </p>
                <div v-if="!scheduled.length" class="u-margin-top-3 u-margin-bottom-3 u-padding-left-2">
                    <i-circle/> Não existem atividades agendadas
                </div>
            ...
            <div v-if="!isEmpty">
                <p class="p-color-gray-40 u-margin-bottom-0">
                    <calendar-blank-multiple/> Atividades finalizadas
                </p>
                <div v-if="!finished.length" class="u-margin-top-3 u-margin-bottom-3 u-padding-left-2">
                    <i-circle/> Não existem atividades finalizadas
                </div>
            ...
            <div v-if="isEmpty" class="p-color-gray-40">
                <i-circle/> Não existe nenhuma atividade associada a você
            </div>
        </CCardBody>
    </CCard>      
  </div>
